...
let ctx = {
    ...
    fill: function() {}
      ...
      function Vehicle(x, y) {
          ...
          this._desiredArrive = new Vector();
          this._steerArrive = new Vector();
          this._desiredFlee = new Vector();
          this._steerFlee = new Vector();
      }
      ...
      Vehicle.prototype.arrive = function(target) {
          var desired = Vector.sub(target, this.pos, this._desiredArrive);
          var d = desired.mag();
          ...
          var steer = Vector.sub(desired, this.vel, this._steerArrive);
          steer.limit(this.maxforce);
          return steer;
      };

      Vehicle.prototype.flee = function(target) {
          var desired = Vector.sub(target, this.pos, this._desiredFlee);
          var d = desired.mag();
          if (d < 50) {
              desired.setMag(this.maxspeed);
              desired.mult(-1);
              var steer = Vector.sub(desired, this.vel, this._steerFlee);
              steer.limit(this.maxforce);
              return steer;
          } else {
              this._steerFlee.x = 0;
              this._steerFlee.y = 0;
              return this._steerFlee;
          }
      };
